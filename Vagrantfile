...
Vagrant::Config.run do |config|
  # Base box to build off, and download URL for when it doesn't exist on
  # the user's system already

  # not working
  #config.vm.box = "trusty-sever-cloudimg-amd64-vagrant-disk1"
  ...
  # As an alternative to precise32, VMs can be built from the
  # 'django-base' box as defined at
  # https://github.com/torchbox/vagrant-django-base , which has more of
  # the necessary server config
  # baked in and thus takes less time to initialise. To go down this
  # route, you will need to build
